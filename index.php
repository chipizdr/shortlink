   ...
   <section class="section main">
    <div class="container">
		...
		<!-- Widgets -->
			...
			<div id="vk_widget" class="column"></div>
			<script type="text/javascript">
			VK.Widgets.Group("vk_widget", {mode: 3, width: "630", height: "1200",color1: 'FFF', color3: '804271'}, 73329584);
			</script>
			<!-- Discord Widget -->
			<div style="margin-left: 10px;" class="column">
			<iframe src="https://discordapp.com/widget?id=552072424313716739&theme=light" height="220" allowtransparency="true" frameborder="0"></iframe>
			</div>
		</div>
    </div>
</section>
